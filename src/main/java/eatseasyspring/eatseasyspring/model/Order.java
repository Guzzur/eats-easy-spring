...
public class Order {
    @Id
    @SequenceGenerator(name="ordersdata_order_id_gen", sequenceName="ordersdata_order_id_seq")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="ordersdata_order_id_gen")
